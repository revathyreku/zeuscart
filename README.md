...
Support to INDIAN CURRENCY & PAYMENT GATEWAYS : we are planning to make zeuscart v4 by default supports indian payment gateways like CCAvenue, InstaMojo, Payzippy, BillDesk etc., We request developers to support us.
